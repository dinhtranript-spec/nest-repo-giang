...
@Injectable()
export class XroadInstanceService {
    private readonly logger = new Logger(XroadInstanceService.name);
    ...
    /**
     * Lấy danh sách tất cả X-Road instances
     * Tương ứng với endpoint GET /xroad-instances trong Java
     */
    async getAll(user: User) {
        const url = `${this.ssConfigUrl}/xroad-instances`;
